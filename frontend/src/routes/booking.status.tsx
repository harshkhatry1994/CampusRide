...
import { CheckCircle2, AlertCircle, ArrowRight, Download, PhoneCall } from "lucide-react";
...
// Failed State Route (Mapped for internal logic)
export const FailedRoute = createFileRoute("/booking/failed")({
